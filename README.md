...
``` html
<script type="module">
    import pkg from '//cdn.pika.dev/caterpillar-filter/^6.5.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/caterpillar-filter@^6.5.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/caterpillar-filter@6.5.0'
</script>
```
